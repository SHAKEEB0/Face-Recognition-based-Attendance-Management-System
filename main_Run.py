...
student_info_frame = tk.LabelFrame(main_frame, text="Student Information", bg='lightgrey')
student_info_frame.grid(row=0, column=0, padx=20, pady=10, sticky="nw")

# Place labels and entry fields within the student_info_frame
lbl = tk.Label(student_info_frame, text="Enter Enrollment : ", width=20, height=2,
               fg="black", bg="lightgrey", font=('times', 15, 'bold'))
lbl.grid(row=0, column=0, padx=5, pady=5, sticky="w")

txt = tk.Entry(student_info_frame, validate="key", width=20, bg="white",
               fg="black", font=('times', 25))
txt['validatecommand'] = (txt.register(testVal), '%P', '%d')
txt.grid(row=0, column=1, padx=5, pady=5, sticky="w")

lbl2 = tk.Label(student_info_frame, text="Enter Name : ", width=20, fg="black",
                bg="lightgrey", height=2, font=('times', 15, 'bold'))
lbl2.grid(row=1, column=0, padx=5, pady=5, sticky="w")

txt2 = tk.Entry(student_info_frame, width=20, bg="white",
                fg="black", font=('times', 25))
txt2.grid(row=1, column=1, padx=5, pady=5, sticky="w")

# Create a clear button for student information
clear_button = tk.Button(student_info_frame, text="Clear", command=clear, fg="white", bg="black",
                        width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clear_button.grid(row=0, column=2, padx=5, pady=5, sticky="w")

clear_button1 = tk.Button(student_info_frame, text="Clear", command=clear1, fg="white", bg="black",
                         width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clear_button1.grid(row=1, column=2, padx=5, pady=5, sticky="w")

# Create a frame for buttons
button_frame = tk.Frame(main_frame, bg='lightgrey')
button_frame.grid(row=1, column=0, padx=20, pady=10, sticky="nw")

# Place buttons within the button_frame
takeImg = tk.Button(button_frame, text="Take Images", command=take_img, fg="black", bg="SkyBlue1",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.grid(row=0, column=0, padx=10, pady=10, sticky="w")

trainImg = tk.Button(button_frame, text="Train Images", fg="black", command=trainimg, bg="SkyBlue1",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.grid(row=0, column=1, padx=10, pady=10, sticky="w")

FA = tk.Button(button_frame, text="Automatic Attendance", fg="black", command=subjectchoose,
               bg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
FA.grid(row=0, column=2, padx=10, pady=10, sticky="w")

quitWindow = tk.Button(button_frame, text="Manually Fill Attendance", command=manually_fill, fg="black",
                       bg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
quitWindow.grid(row=0, column=3, padx=10, pady=10, sticky="w")

AP = tk.Button(button_frame, text="Check Registered students", command=admin_panel, fg="black",
               bg="SkyBlue1", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.grid(row=1, column=2, padx=10, pady=10, sticky="w")

# Place the message label
message = tk.Label(main_frame, text="Attendance Management System using Face Recognition", bg="black", fg="white", width=50,
                   height=3, font=('times', 30, ' bold '))
message.grid(row=2, column=0, padx=20, pady=10, sticky="nw")

# Place the notification label
Notification = tk.Label(main_frame, text="All things good", bg="Green", fg="white", width=15,
                        height=3, font=('times', 17))
Notification.grid(row=3, column=0, padx=20, pady=10, sticky="nw")
